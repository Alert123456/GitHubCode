...
static const char qt_meta_stringdata_Teacher[] = {
    "Teacher\0\0hungry()\0foodName\0hungry(QString)\0"
    "classIsOver()\0"
};
...
void Teacher::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->classIsOver(); break;
        default: ;
        }
    }
}

const QMetaObjectExtraData Teacher::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject Teacher::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_Teacher,
      qt_meta_data_Teacher, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &Teacher::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Teacher))
